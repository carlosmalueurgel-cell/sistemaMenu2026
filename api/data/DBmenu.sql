...
FOREIGN KEY(cod_empleado) REFERENCES USUARIOS(id)
)ENGINE=InnoDB;
...
FOREIGN KEY(creado_por) REFERENCES PRODUCTOS(id)
)ENGINE=InnoDB;
...
FOREIGN KEY(creado_por) REFERENCES PEDIDOS(id)
)ENGINE=InnoDB;
...
CREATE TABLE PEDIDOS_EMPLEADO(
cod_pedido int not null,
cod_empleado int not null,
fecha date not null DEFAULT(NOW()),
PRIMARY KEY(cod_pedido),
FOREIGN KEY(cod_pedido) REFERENCES EMPLEADO(id),
FOREIGN KEY(cod_empleado) REFERENCES PEDIDOS(id)
)ENGINE=InnoDB;
